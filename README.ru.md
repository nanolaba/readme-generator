...
3. [Синтаксис шаблона](#синтаксис-шаблона)
	...
	2. [Свойства](#свойства)
	3. [Переопределения для разных языков](#переопределения-для-разных-языков)
	4. [Переменные окружения](#переменные-окружения)
	5. [Значения из Maven POM](#значения-из-maven-pom)
	6. [Значения из package.json](#значения-из-packagejson)
	7. [Значения из Gradle](#значения-из-gradle)
	8. [Multilanguage support](#multilanguage-support)
	9. [Игнорирование фрагментов](#игнорирование-фрагментов)
	10. [Замороженные области](#замороженные-области)
	11. [Виджеты](#виджеты)
...
```markdown
Last updated: 27.04.2026 14:24:32
```
