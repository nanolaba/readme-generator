...
**Nanolaba Readme Generator (NRG)** — инструмент автоматической генерации markdown-файлов, работающий с
шаблонами-прототипами
и поддерживающий многоязычность, импорт файлов, переменные и кастомные виджеты для динамического наполнения.
