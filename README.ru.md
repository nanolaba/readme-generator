...
Отдельный репозиторий (`nanolaba/nrg-action`) с публикацией в Marketplace запланирован; пока что источником истины служит этот каталог.
...
```markdown
Last updated: 26.04.2026 01:15:59
```
