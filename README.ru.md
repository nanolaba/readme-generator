<!-- This file was automatically generated by Nanolaba Readme Generator (NRG) 1.2-SNAPSHOT -->
...
Текущая версия разработки — **1.2-SNAPSHOT**.
...
2. [Способы запуска программы](#способы-запуска-программы)
	1. [Запуск из командной строки](#запуск-из-командной-строки)
		...
		6. [Перевод строк](#перевод-строк)
		7. [Настройка заголовка](#настройка-заголовка)
		8. [Несколько файлов и glob-паттерны](#несколько-файлов-и-glob-паттерны)
...
3. [Синтаксис шаблона](#синтаксис-шаблона)
	...
	2. [Обратные слэши и экранирование](#обратные-слэши-и-экранирование)
	3. [Свойства](#свойства)
	4. [Переопределения для разных языков](#переопределения-для-разных-языков)
	5. [Переменные окружения](#переменные-окружения)
	6. [Значения из Maven POM](#значения-из-maven-pom)
	7. [Значения из package.json](#значения-из-packagejson)
	8. [Значения из Gradle](#значения-из-gradle)
	9. [Multilanguage support](#multilanguage-support)
	10. [Игнорирование фрагментов](#игнорирование-фрагментов)
	11. [Замороженные области](#замороженные-области)
	12. [Виджеты](#виджеты)
		1. [Виджет 'languages'](#виджет-languages)
		2. [Виджет 'import'](#виджет-import)
		3. [Виджет 'tableOfContents'](#виджет-tableofcontents)
		4. [Виджет 'date'](#виджет-date)
		5. [Виджет 'todo'](#виджет-todo)
		6. [Виджет 'alert'](#виджет-alert)
		7. [Виджет 'badge'](#виджет-badge)
		8. [Виджет 'math'](#виджет-math)
		9. [Виджет 'exec'](#виджет-exec)
		10. [Виджет 'if'](#виджет-if)
		11. [Виджет 'fileTree'](#виджет-filetree)
...
**Вариант A — CLI.** [Скачайте](https://github.com/nanolaba/readme-generator/releases/tag/v1.1) автономный jar, распакуйте архив и запустите:
...
[Скачайте](https://github.com/nanolaba/readme-generator/releases/tag/v1.1) последнюю 
...
Скачайте JAR из [Maven Central](https://repo1.maven.org/maven2/com/nanolaba/readme-generator/1.1)
...
```markdown
Last updated: 30.04.2026 22:08:42
```
