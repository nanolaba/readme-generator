...
|:-------------------------------:|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------:|
|              type               | ${en:'One of: `maven-central`, `license`, `github-release`, `github-stars`, `custom`.', ru:'Одно из: `maven-central`, `license`, `github-release`, `github-stars`, `custom`.'} |           ${en:'all', ru:'все'}            |
...
|              repo               | ${en:'GitHub repository `owner/name`.', ru:'Репозиторий GitHub `owner/name`.'}                                                                                                 |      `github-release`, `github-stars`      |
